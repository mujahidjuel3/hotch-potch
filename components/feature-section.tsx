    ...
    <section className="py-16 bg-gray-900 text-white">
      <div className="container mx-auto px-4 grid gap-32 lg:grid-cols-2">
        ...
        <div className="relative w-full max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#FAFAFA] text-black p-6 rounded-lg  h-[33rem] md:h-[30rem] lg:h-[37rem] xl:h-[30rem]">
            ...
            <ul className="space-y-3 bg-[#B7B8BB] px-3 py-2 rounded">
              <li className="text-sm md:text-base">
                <strong>Pain:</strong> You are an e-commerce business, and you
                want to sell your products all over the country, but you are
                confused about how to handle sales tax.
              </li>
              <li className="text-sm md:text-base">
              ...
              <li className="text-sm md:text-base">
                <strong>Solution:</strong> Use TaxTool, our full-stack solution,
